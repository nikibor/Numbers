...
namespace Numbers
{
    class English : Language
    {
        public English()
        {
            ...
            this.Units = new List<string> { String.Empty, "one", "two", "three", "four", "five", "six", "seven", "eight", "nine" };
            this.Tens = new List<string> { "ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen" };
